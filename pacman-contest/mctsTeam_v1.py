        ...
        while time < limit:
            ...
            if len(attackers) != 0:
                if nearestAttacker != None:
                    if self.getMazeDistance(currentPosition, nearestAttacker.getPosition()) < 1:
                        reward = (10000) * math.pow(gamma, time)
                        return reward
                    elif self.getMazeDistance(currentPosition, nearestAttacker.getPosition()) < 2:
                        reward = (1000) * math.pow(gamma, time)
                        return reward
                    elif self.getMazeDistance(currentPosition, nearestAttacker.getPosition()) < 3:
